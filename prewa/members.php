...
<div class="row" data-anim-type="zoom-in" data-anim-delay="100">
 <div  class="sec_title" style="margin-top: -40px"><h1>Members</h1></div>
...
<?php
$query="select * from tbl_member where membership_type=3 order by membership_no ASC";
...
<style type="text/css">
	...
	<div class="col-md-3 col-sm-3" style="margin-top: 29px; margin-left: 30px"><a target="_blank" href="images/general_members/<?php echo $row['image'];?>"><img src="images/general_members/<?php echo $row['image'];?>" class="img-responsive" alt=" " style="width: 220px;height: 220px;"></a></div>
