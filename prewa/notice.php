...
<div class="row" data-anim-type="zoom-in" data-anim-delay="100">
 ...
 <div  class="sec_title" style="margin-top: -40px"><h1>Notice</h1></div>
...
<table id="dtBasicExample" class="table table-striped table-bordered" cellspacing="0" width="100%">
    ...
    <tr>
      ...
      <th class="th-sm" style="width: 28%">Description
      ...
      <th class="th-sm" style="width: 20%">Date
  ...
  <tbody>
    ...
    <!--<tr>
      ...
      <td><a href=""><img src="images/download.png" style="width: 20px;height: 20px"></a></td>
